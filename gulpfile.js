...
gulp.task(
	...
	gulp.series('clean:docs', 
		gulp.parallel('pug:docs', 'sass:docs', 'imagesWebp:docs', 'images:docs', 'fonts:docs', 'uploadsWebp:docs', 'uploads:docs', 'svgSprite:docs', 'svg:docs', 'js:docs', 'root:docs'),
